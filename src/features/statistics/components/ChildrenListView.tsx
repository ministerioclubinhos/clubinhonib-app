  ...
  return (
    <Box sx={{ width: '100%', maxWidth: '100%', overflowX: 'hidden' }}>
      ...
      <Grid
        container
        spacing={{ xs: 1.5, sm: 2 }}
        sx={{ mb: 3, width: '100%', maxWidth: '100%', margin: 0 }}
      >
                    ...
                    >
                      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, flex: 1 }}>
                        ...
                        <Box sx={{ flex: 1, minWidth: 0 }}>
                          <Typography
                            fontWeight="medium"
                            sx={{ fontSize: { xs: '0.8rem', sm: '1rem' }, wordBreak: 'break-word' }}
                          >
                            {child.name}
                          </Typography>
                          <Typography
              ...
              {data.children.map((child) => (
                <TableRow key={child.childId} hover>
                  ...
                  <TableCell align="center">
                    <Chip label={`${child.monthsParticipating}m`} size="small" variant="outlined" />
                  </TableCell>
