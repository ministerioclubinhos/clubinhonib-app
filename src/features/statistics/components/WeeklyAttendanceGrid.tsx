...
export const WeeklyAttendanceGrid: React.FC = () => {
  ...
  const isCurrentWeek =
    academicYear === currentWeekInfo?.academicYear &&
        ...
        >
            ...
            <Box>
              ...
              {data.weekRange.start && data.weekRange.end && (
                <Typography variant="caption" color="text.secondary">
                  {dayjs(data.weekRange.start).format('DD/MM')} -{' '}
                  {dayjs(data.weekRange.end).format('DD/MM/YYYY')}
                </Typography>
              )}
            </Box>
          </Box>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
            <IconButton
              ...
              disabled={academicWeek === null || academicWeek <= 1}
            >
              <NavigateBefore />
            </IconButton>
            <TextField
        ...
        >
          ...
          {data.period && (
            <Typography variant="body2" color="text.secondary" sx={{ mt: 1 }}>
              Período letivo: {dayjs(data.period.startDate).format('DD/MM/YYYY')} até{' '}
      ...
      {!hasClubs && !data.note && (
        ...
        >
          <Typography color="text.secondary">
            Nenhum clubinho encontrado para esta semana.
          </Typography>
        </Paper>
      )}
        ...
        <>
          ...
          <Grid container spacing={2} sx={{ mb: 3 }}>
            <Grid item xs={12} sm={6} md={2.4}>
              <Paper
                elevation={0}
                sx={{ p: 2, borderRadius: 2, border: `2px solid ${theme.palette.divider}` }}
              >
                <Typography variant="caption" color="text.secondary">
                  Total de Clubinhos
                </Typography>
            ...
            <Grid item xs={12} sm={6} md={2.4}>
              ...
              >
                ...
                <Typography
                  variant="h5"
                  fontWeight="bold"
                  color={data.summary.attendanceRate >= 80 ? 'success.main' : 'warning.main'}
                >
