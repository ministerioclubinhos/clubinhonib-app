    ...
    <Paper elevation={0} sx={{ borderRadius: 3, overflow: 'hidden', border: `1px solid ${theme.palette.divider}` }}>
      ...
      <TableContainer sx={{ maxHeight: 800 }}>
        <Table stickyHeader>
          <TableHead>
            <TableRow>
              <TableCell width={50} sx={{ bgcolor: 'grey.50', fontWeight: 'bold' }}></TableCell>
              <TableCell sx={{ bgcolor: 'grey.50', fontWeight: 'bold' }}>Clube</TableCell>
              <TableCell sx={{ bgcolor: 'grey.50', fontWeight: 'bold' }}>Dia</TableCell>
              <TableCell sx={{ bgcolor: 'grey.50', fontWeight: 'bold' }}>Crianças</TableCell>
      ...
      {/* ⭐ Paginação do Backend para lista de clubes */}
