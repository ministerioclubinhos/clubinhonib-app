...
export function ChildrenPanel({
  ...
  if (!club) {
    return (
      <PlaceholderCard
        title="Escolha um Clubinho"
        subtitle="Clique em um Clubinho para ver suas crianças."
      />
    );
  }
      ...
      <Box sx={{ flex: 1, overflow: 'auto', pr: 1 }}>
        <Stack spacing={1}>
          ...
          {!loading && !error && rows.length === 0 && (
            <EmptyState
              title="Sem crianças neste Clubinho"
              subtitle="Cadastre crianças ou escolha outro Clubinho."
            />
          )}
          ...
          {!loading &&
            ...
            rows.map((c) => {
              ...
              const avatarFg =
                c.gender === 'F' ? theme.palette.secondary.main : theme.palette.info.main;
                    ...
                    {isMobile ? (
                      <Stack spacing={0.75} sx={{ p: 1.25, minHeight: touchMin }}>
                        <Stack direction="row" alignItems="center" spacing={1.5}>
                          ...
                          <Typography
                            variant="subtitle1"
                            sx={{ fontWeight: 600, lineHeight: 1.1, flex: 1 }}
                          >
                            {c.name}
                          </Typography>
                        </Stack>
