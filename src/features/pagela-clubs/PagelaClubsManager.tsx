      ...
      <AppBar position="static" color="default" elevation={0}>
        <Toolbar sx={{ gap: 2 }}>
          {isMobile && mobileStep !== 'clubs' ? (
            ...
            <>
              {isMobile && <BackHeader title="Clubinhos▸Crianças▸Pagelas" mobileFontSize="1rem" />}
            </>
          )}
              ...
              <Card sx={{ height: '100%', display: 'flex', flexDirection: 'column', minHeight: 0 }}>
                ...
                >
                  <SectionHeader
                    context="clubs"
                    title="Clubinhos"
                    subtitle="Selecione um clubinho para ver as crianças"
                  />
              ...
              <Card sx={{ height: '100%', display: 'flex', flexDirection: 'column', minHeight: 0 }}>
                ...
                >
                  <SectionHeader
                    ...
                    title="Crianças"
                    subtitle={
                      selectedClub ? `Clubinho #${selectedClub.number}` : 'Escolha um Clubinho'
                    }
                  />
                  <Box sx={{ flex: 1, minHeight: 0 }}>
                    <ChildrenPanel
              ...
              <Card sx={{ flex: 1, overflow: 'hidden', minHeight: 0, display: 'flex' }}>
                ...
                >
                  <SectionHeader
                    context="clubs"
                    title="Clubinhos"
                    subtitle="Toque em um clubinho para avançar"
                  />
                  <Box sx={{ flex: 1, minHeight: 0 }}>
                    <ClubsPanel
                      onSelect={(club) => {
