...
const WeekMaterialsList = () => {
  ...
  const weekMaterialsRoutes = routes
    .filter((route) => route.entityType === MediaTargetType.WeekMaterialsPage && route.public)
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                Explore materiais atualizados semanalmente para enriquecer suas aulas e atividades
                do Clubinho
              </Typography>
            </Box>
            ...
            >
              <TextField
                ...
                InputProps={{
                  ...
                  endAdornment: filter && (
                    <IconButton size="small" onClick={() => setFilter('')} sx={{ mr: -1 }}>
