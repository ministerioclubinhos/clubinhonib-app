...
export default function TeacherMeditationBanner() {
  ...
  const currentMeditation = useSelector((state: RootState) => state.meditation.meditationData);
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              O tema de hoje é: <span style={{ fontWeight: 'bold' }}>{meditationDay.title}</span>
            </Typography>
          </Box>
