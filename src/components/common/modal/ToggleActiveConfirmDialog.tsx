    ...
    >
      <DialogTitle
        ...
        sx={{
          ...
          color: (t) => isActive ? t.palette.warning.contrastText : t.palette.success.contrastText,
          display: "flex",
          alignItems: "center",
          gap: 1,
          py: { xs: 1.5, sm: 2 },
      ...
      >
        ...
        <Button
          ...
          variant="contained"
          startIcon={isActive ? <ToggleOffIcon fontSize="small" /> : <ToggleOnIcon fontSize="small" />}
          disabled={loading}
          fullWidth
          size="large"
          sx={{ 
